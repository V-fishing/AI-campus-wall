...
这是个 Spring Boot 3.4 的单体后端，从用户、帖子、评论、私信、AI 学长、内容审核一直到整个管理端的业务都在里头，按领域分了包（社交、社区、AI、管理端、基础设施）。规模上 285 个 Java 文件、约 2.4 万行，33 个 Controller、75 个 Service、约 38 张表、20 个 Flyway 迁移脚本，基本是我一个人写的。
