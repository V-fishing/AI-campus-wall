...
剩下的几块放一篇里说，每块挑一两处我觉得有意思的地方、配点代码。前端这边 AI 对话和实时私信是我负责的两条核心链路，运维监控和数据管道也基本是我做的，运营后台的框架和权限是我搭的。
...
Python 写的 ETL，约 660 行，只依赖 pymysql 和 requests 两个第三方包。它把社区里的帖子和评论、还有微信群导出，清洗、脱敏、假名化之后收敛成"问题—参考答案"的知识单元，推给 AI 服务建图谱。
